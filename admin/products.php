                            ...
                            <div class="card-body" style="background-color: lightgray;">
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                        <input type="number" class="form-control" name="productQtyAvailable" id="productQtyAvailable" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="productPrice" class="col-sm-2 col-form-label">Price (CAD)</label>
                                        <div class="col-sm-10">
                                        <input type="number" class="form-control" name="productPrice" id="productPrice" pattern="\d+(\.\d{2})?" required>
                                        </div>
                                    </div>
                                        
                                        
                                        
                                    <button type="submit" name="btnAddProduct" class="btn btn-secondary">Add Product</button>
                                </form>
                            </div>
                        </div>
                    </div>
